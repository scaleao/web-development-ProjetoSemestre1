...
<html lang="pt" dir="ltr">
  ...
  <body>
    <div class="panel-title">
      <div class="object-panel-title" id="responsive">
      ...
      <div class="object-panel-title align-right">
        <form method="POST" action="./app/logic/processamento_login.php">
          <div class="object-panel-title">
            <input type="text" class="text-login" name="login" placeholder="Login">
          </div>
          <div class="object-panel-title">
            <input type="password" class="password-login" name="senha" placeholder="Senha">
    ...
    <div class="panel">
      <div>
      <h3 class="error"><?=fromSession("messages-error");?></h3>
      <h3 class="sucess"><?=fromSession("messages-sucess");?></h3>
      </div>
      <header class="titulo">
